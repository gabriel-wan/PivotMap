...
- Attach source IDs when the requirement comes from an external job post or employer page.

## Output

Return structured target requirements that can become `GapNode` records.
